...
import { div, h1, image, link } from "framer-motion/client"
...
const ProjectCard = ({ project }) => {
  return (
    <ScrollReveal>
       <div className="flex flex-col items-center gap-6 md:flex-row md:gap-24">
     
      
        <img
        src={project.image} alt="" className="w-[500px] cursor-pointer
